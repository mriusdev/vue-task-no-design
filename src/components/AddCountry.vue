        ...
        <div class="modal is-active">
            ...
            <div class="modal-content">
                <div class="box">
                    ...
                    <div class="field">
                        <input name="data.attributes.phone_code" v-model="data.attributes.phone_code" class="input" type="number" placeholder="Salies Tel. kodas">
                        <span class="help is-danger" v-text="errors.get('data.attributes.phone_code')"></span>
                    </div>
...
export default {
    ...
    methods: {
        postData() {
            return this.$http.post('https://akademija.teltonika.lt/countries_api/api/countries', {
                // name: this.name,
                // area: this.area,
